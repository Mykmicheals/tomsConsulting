                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="site-footer-wrap d-flex align-items-center">
                            <p class="copyright-text mb-0 me-4">Copyright © Toms consulting</p>
                    ...
                    <div class="col-lg-6 col-12">
                        <p class="copyright-text mb-0 me-4">Designed by Andrew <a
                            href="https://www.tooplate.com/" target="_blank">Micheal</a></p>
                    </div>
